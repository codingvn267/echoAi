...
import { VapiFormFields } from "@/modules/plugins/ui/components/vapi-form-fields";
...
export const CustomizationForm = ({
  ...
  const form = useForm<FormSchema>({
    ...
    defaultValues: {
      ...
      defaultSuggestions: {
        suggestion1: initialData?.defaultSuggestions.suggestion1 === "suggestion 1" ? "" : (initialData?.defaultSuggestions.suggestion1 || ""),
        suggestion2: initialData?.defaultSuggestions.suggestion2 === "suggestion 2" ? "" : (initialData?.defaultSuggestions.suggestion2 || ""),
        suggestion3: initialData?.defaultSuggestions.suggestion3 === "suggestion 3" ? "" : (initialData?.defaultSuggestions.suggestion3 || ""),
      },
      vapiSettings: {
